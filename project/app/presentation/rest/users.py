...
@router.get("/age", dependencies=[Depends(JWTBearer())], status_code=status.HTTP_200_OK)
...
@router.get("/users_by_color", dependencies=[Depends(JWTBearer())], status_code=status.HTTP_200_OK)
...
@router.get("/unique_names", dependencies=[Depends(JWTBearer())], status_code=status.HTTP_200_OK)
